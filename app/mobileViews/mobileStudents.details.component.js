...
var MobileStudentDetailsComponent = (function () {
    function MobileStudentDetailsComponent(dataService, _service, route) {
    ...
    MobileStudentDetailsComponent = __decorate([
        core_1.Component({
    ...
    ], MobileStudentDetailsComponent);
    return MobileStudentDetailsComponent;
}());
exports.MobileStudentDetailsComponent = MobileStudentDetailsComponent;
//# sourceMappingURL=mobileStudents.details.component.js.map